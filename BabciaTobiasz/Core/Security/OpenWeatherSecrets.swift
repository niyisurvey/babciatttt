//
//  OpenWeatherSecrets.swift
//  BabciaTobiasz
//
//  Loads the OpenWeather API key from Keychain or Secrets.plist.
//

import Foundation

enum OpenWeatherSecrets {
    static func apiKey() -> String? {
        if let stored = OpenWeatherKeychain.load(), !stored.isEmpty {
            return stored
        }
        let secretsURL: URL?
#if SWIFT_PACKAGE
